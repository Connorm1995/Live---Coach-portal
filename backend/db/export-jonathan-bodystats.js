/**
 * Export all of Jonathan Stanley's body weight + body fat measurements,
...
const TID = 20867560;            // Jonathan Stanley
const START = '2024-12-09';      // his trainerize join date (first possible log)
const END = new Date().toISOString().split('T')[0];
const OUT = path.resolve(__dirname, '../../jonathan-stanley-bodystats.csv');
...
(async () => {
  console.log(`Fetching body stats for Jonathan Stanley (${TID}) from ${START} to ${END}...`);
