...
const QUESTIONS = [
  // Identity - see the note on the same question in checkin-definition.js.
  ...
  { id: 'training_issue', kind: 'choice', number: '3a',
  ...
  { id: 'step_issue', kind: 'choice', number: '4a',
    ref: 'eom-step-issue',
  ...
  { id: 'nutrition_issue', kind: 'choice', number: '5a',
    ...
    answerType: 'choice' },
  { id: 'nutrition_info_vs_execution', kind: 'choice', number: '5b',
  ...
  { id: 'sleep_rating', kind: 'scale', number: 7,
  ...
  { id: 'sleep_issue', kind: 'choice', number: '7a',
    ref: 'eom-sleep-issue',
  ...
  { id: 'digestion_rating', kind: 'scale', number: 8,
  ...
  { id: 'digestion_issue', kind: 'choice', number: '8a',
  ...
  { id: 'stress_rating', kind: 'scale', number: 9,
  ...
  { id: 'stress_source', kind: 'textarea', number: '9a',
  ...
  { id: 'progress_direction', kind: 'choice', number: 10,
  ...
  { id: 'overall_performance', kind: 'scale', number: 11,
  ...
  { id: 'direction_confidence', kind: 'scale', number: 12,
  ...
  { id: 'help_request', kind: 'multichoice', number: 13,
  ...
  { id: 'advice_to_past_self', kind: 'textarea', number: 14,
    ref: 'eom-hindsight',
