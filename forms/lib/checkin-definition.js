...
const QUESTIONS = [
  { id: 'overall_performance', kind: 'scale', number: 1,
  ...
  { id: 'sleep_issue', kind: 'textarea', number: '7a',
  ...
  { id: 'digestion_issue', kind: 'textarea', number: '8a',
  ...
  { id: 'help_request', kind: 'multichoice', number: 11,
    ...
    otherOption: true },
  { id: 'upcoming_notes', kind: 'textarea', number: 12,
